...
phase 1:
<img width="560" height="482" alt="image" src="https://github.com/user-attachments/assets/b73cc6b7-dfc4-4e25-83e2-ad371e4459a7" />
create strandarized grid overlay across entire routing region (floorplan); dimensins shoudl follow industry standards. 

<img width="179" height="142" alt="image" src="https://github.com/user-attachments/assets/4699557d-4412-4686-a564-ca84888ecf16" />
phase 2: wave propogation labelling process
<img width="179" height="142" alt="image" src="https://github.com/user-attachments/assets/1736613a-41bd-4721-be2d-53784411fce8" />
...
<img width="179" height="142" alt="image" src="https://github.com/user-attachments/assets/39fed0e9-57d7-4b5a-8b1b-492bf2205b60" />
...
<img width="889" height="479" alt="image" src="https://github.com/user-attachments/assets/c6ca6cc3-cc73-4f01-8994-f2fb4e5830ba" />
...
<img width="314" height="479" alt="image" src="https://github.com/user-attachments/assets/901b33be-c63e-40ca-997d-1a132094b732" />

<img width="314" height="479" alt="image" src="https://github.com/user-attachments/assets/c0df82d5-f957-48b8-b73d-3aed9f9584e6" />
...
Lab steps to build power distribution netowkr:

<img width="590" height="526" alt="image" src="https://github.com/user-attachments/assets/bc52ca3e-2b9d-4d63-a279-87e1cd00803b" />
I currently don't have a CURRENT_DEF var.

gen_pdn (to create powernet)

should create the grid; can find properties in the def file.

<img width="299" height="121" alt="image" src="https://github.com/user-attachments/assets/1a2d8643-19aa-408f-83ac-ce0ad06e55a4" />

heres an example of what the rails should mean. 

<img width="498" height="330" alt="image" src="https://github.com/user-attachments/assets/498ffeb0-d2ee-4f97-814f-0d923c808fa7" />
...
1) Fast Route (Flobal Route) ~ represented as a 3d graph.
...
<img width="592" height="260" alt="image" src="https://github.com/user-attachments/assets/b6d219df-5381-43fd-aa8b-a55d10d26a16" />
...
<img width="592" height="260" alt="image" src="https://github.com/user-attachments/assets/bbe5d18b-fa85-473f-be8d-105101fccbfa" />
...
Access Point Cluster Architecture: Grouped collections of access points associated with specific routing segments: (like pins or i/o ports things like that)
...
<img width="349" height="177" alt="image" src="https://github.com/user-attachments/assets/1eb6c9e6-2d95-404f-b84b-0c24f844b98d" />
...
<img width="670" height="117" alt="image" src="https://github.com/user-attachments/assets/f40ca950-2092-4beb-86cd-0af6b511599e" />
don't have spef_extractor in my tools folder. 

if you do the command abobe, idealy new spef will be created in results/routing of most recent run. 
